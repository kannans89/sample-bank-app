...
<html>
	...
	<body>
		<s:form name="form" action="transactionAction" theme="bootstrap" cssClass="form-horizontal">
            		...
            		<div class="panel col-sm-10 text-left">
        				<div class="panel panel-primary">
            				...
            				<div class="panel-body">
								...
								<table  align="center">
									<tr><td><s:textfield name="amount" label="Enter Amount"></s:textfield></td></tr>
									<tr><td><s:radio list="transList" name="transChoice" label="Select Transaction"></s:radio></td></tr>
	 								<tr><td><h4 align="center"><s:submit value="Commite" Class="btn btn-primary"></s:submit> <a href="homeAction" class="btn btn-info">Cancel</a></h4></td></tr>
								</table>
							</div>
						</div>
                	</div>
